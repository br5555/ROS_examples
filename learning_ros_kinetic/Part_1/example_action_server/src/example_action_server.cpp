...
//This example uses the “simple” action server library. The simple version does not at-
//tempt to handle multiple goals in parallel, nor does it attempt to queue requests. Any goal
//requested while a goal is still in process will cause pre-emption of the goal in process. This
//is true whether the conflicting goals come from a single client or from multiple clients run-
//ning in parallel. The designer must consider implications of this behavior when using simple
//action servers.
